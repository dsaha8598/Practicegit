 ...
 *
 */
public class CollecteeGstinStatusRowMapper implements RowMapper<CollecteeGstinStatus> {

	@Override
	public CollecteeGstinStatus mapRow(ResultSet rs, int rowNum) throws SQLException {
		CollecteeGstinStatus collecteeGstinStatus = new CollecteeGstinStatus();
