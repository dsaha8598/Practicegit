 ...
 *
 */
public class DeducteeGstinAndDeducteeResDTORowMapper implements RowMapper<DeducteeGstinAndDeducteeResDTO> {

	@Override
	public DeducteeGstinAndDeducteeResDTO mapRow(ResultSet rs, int rowNum) throws SQLException {
		DeducteeGstinAndDeducteeResDTO deducteeGstinStatus = new DeducteeGstinAndDeducteeResDTO();
		...
		// deductee res
		deducteeGstinStatus.setDeductorCode(rs.getString("deductor_code"));
		deducteeGstinStatus.setDeductorCode(rs.getString("deductor_name"));
		deducteeGstinStatus.setDeducteeName(rs.getString("deductee_master_name"));
		deducteeGstinStatus.setDeducteeCode(rs.getString("deductee_code"));
		deducteeGstinStatus.setDeducteePAN(rs.getString("deductee_master_pan"));
		deducteeGstinStatus.setDeducteeGSTIN(rs.getString("gstin_number"));
