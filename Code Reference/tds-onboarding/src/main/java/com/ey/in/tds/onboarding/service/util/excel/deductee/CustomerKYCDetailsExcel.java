 ...
 *
 */
public class CustomerKYCDetailsExcel extends Excel<KYCDetails, KYCDetailsErrorFilDTO> {

	private static final String HEADER_CUSTOMER_NAME = "Customer Name";
	private static final String HEADER_CUSTOMER_PAN = "Customer PAN";
	private static final String HEADER_CUSTOMER_CODE = "Customer Code";
	...
	public static List<FieldMapping> fieldMappings = Collections.unmodifiableList(Arrays.asList(
			new FieldMapping(HEADER_CUSTOMER_NAME, "customerName", "customerName", Excel.VALIDATION_MANDATORY),
			new FieldMapping(HEADER_CUSTOMER_PAN, "customerPan", "customerPan"),
			new FieldMapping(HEADER_CUSTOMER_CODE, "customerCode", "customerCode", Excel.VALIDATION_MANDATORY),
	...
	public CustomerKYCDetailsExcel(XSSFWorkbook workbook) {
