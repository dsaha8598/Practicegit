...
public class ShareholderMasterNonResidentialRowMapper implements RowMapper<ShareholderMasterNonResidential>{

	@Override
	public ShareholderMasterNonResidential mapRow(ResultSet rs, int rowNum) throws SQLException {
		ShareholderMasterNonResidential dto=new ShareholderMasterNonResidential();
		
		dto.setId(rs.getInt("shareholder_master_id"));
		dto.setAreaLocality(rs.getString("area_locality"));
		//dto.setAssessmentYearDividendDetails(null);
		...
		dto.setIsBeneficialOwnershipDeclarationAvailable(rs.getInt("is_beneficial_ownership_declaration_available")==1?true:false);
		dto.setIsCommercialIndemnityOrTreatyBenefitsWithoutDocuments(rs.getInt("is_commercial_indemnity_or_treaty_benefits_without_documents")==1?true:false);
		dto.setIsIcelandRateLessThanTwenty(rs.getInt("is_iceland_rate_less_than_twenty")==1?true:false);
		dto.setIsKuwaitShareholderType(rs.getInt("is_iceland_rate_less_than_twenty")==1?true:false);
		dto.setIsMliSlobSatisfactionDeclarationAvailable(rs.getInt("is_mli_slob_satisfaction_declaration_available")==1?true:false);
		dto.setIsNoPeDeclarationAvailable(rs.getInt("is_no_pe_declaration_available")==1?true:false);
		dto.setIsNoPoemDeclarationAvailable(rs.getInt("is_no_poem_declaration_available")==1?true:false);
		...
		dto.setPanVerifiedDate(rs.getDate("pan_verified_date"));
		...
		dto.setShareHeldToDate(rs.getTimestamp("share_held_from_date"));
		...
		dto.setShareTransferAgentName(rs.getString("name"));
