...
import com.ey.in.tds.TDSOnboardingApplication;
...
public class OnboardingTenantResource {
	...
	public ResponseEntity<Map<String, String>> buildNumber() {
		Map<String, String> response = new AppUtils().getManifestAttributes(TDSOnboardingApplication.class,
				"tds-onboarding");
