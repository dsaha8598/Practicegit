 ...
 *
 */
public class ShareholderKYCDetalsExcle extends Excel<KYCDetails, KYCDetailsErrorFilDTO> {

	private static final String HEADER_SHAREHOLDER_NAME = "Shareholder Name";
	private static final String HEADER_SHAREHOLDER_PAN = "Shareholder PAN";
	private static final String HEADER_SHAREHOLDER_CODE = "Shareholder Code";
	...
	public static List<FieldMapping> fieldMappings = Collections.unmodifiableList(Arrays.asList(
			new FieldMapping(HEADER_SHAREHOLDER_NAME, "customerName", "customerName", Excel.VALIDATION_MANDATORY),
			new FieldMapping(HEADER_SHAREHOLDER_PAN, "customerPan", "customerPan"),
			new FieldMapping(HEADER_SHAREHOLDER_CODE, "customerCode", "customerCode", Excel.VALIDATION_MANDATORY),
	...
	public ShareholderKYCDetalsExcle(XSSFWorkbook workbook) {
