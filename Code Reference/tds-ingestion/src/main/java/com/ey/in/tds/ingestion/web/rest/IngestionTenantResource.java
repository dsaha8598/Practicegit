...
import com.ey.in.tds.IngestionApplication;
...
public class IngestionTenantResource {
	...
	public ResponseEntity<Map<String, String>> buildNumber() {
		Map<String, String> response = new AppUtils().getManifestAttributes(IngestionApplication.class,
				"tds-ingestion");
		return new ResponseEntity<Map<String, String>>(response, HttpStatus.OK);
	}
	
	@GetMapping("/test")
	public ResponseEntity<Map<String, String>> redisDataFlush() throws InterruptedException {
		...
		if (logger.isInfoEnabled())
		 ...
		 Thread.sleep(180000);
		    System.out.println(
		      ...
		      "' is woken after sleeping for 180 seconds");
		return new ResponseEntity<Map<String, String>>(response, HttpStatus.OK);
	}
}
