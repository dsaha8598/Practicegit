 ...
 *
 */
public class SurchargeMasterExcel extends MasterExcel<ArticleRateMasterDTO, ArticleRateMasterErrorReportDTO> {
	...
	public SurchargeMasterExcel(XSSFWorkbook workbook) {
