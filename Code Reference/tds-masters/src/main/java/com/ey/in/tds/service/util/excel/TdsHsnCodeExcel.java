 ...
 *
 */
public class TdsHsnCodeExcel extends MasterExcel<TdsHsnCodeExcelDTO, TdsHsnCodeErrorReportDTO> {
	...
	public static final List<FieldMapping> fieldMappings = Collections.unmodifiableList(Arrays.asList(
			new FieldMapping(HEADER_HSN_OR_SAC_CODE, "hsnCode", "hsnCode", MasterExcel.VALIDATION_MANDATORY),
			new FieldMapping(HEADER_DESCRIPTION, "desc", "desc", MasterExcel.VALIDATION_MANDATORY),
