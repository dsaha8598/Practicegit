 ...
 *
 */
public class ArticleMasterExcel extends MasterExcel<ArticleRateMasterDTO, ArticleRateMasterErrorReportDTO> {
	...
	public ArticleMasterExcel(XSSFWorkbook workbook) {
