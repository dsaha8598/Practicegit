...
@Component({
  selector: 'ey-month-tracker-form',
  templateUrl: './month-tracker-form.component.html',
  styleUrls: ['./month-tracker-form.component.scss']
})
export class MonthTrackerFormComponent implements OnInit {
  ...
  constructor(
    private readonly monthTrackerService: MonthTrackerService,
  ...
  goBack(): void {
    this.router
      .navigate(['/dashboard/masters/monthtracker'])
      .then()
      .catch();
  }
  get f(): any {
