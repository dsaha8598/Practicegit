...
import { IpfmTcsformComponent } from './ipfm-tcsform.component';
import { IpfmTcsService } from '../ipfm-tcs.service';
import { By } from '@angular/platform-browser';
describe('IpfmTcsformComponent', () => {
  let component: IpfmTcsformComponent;

  let fixture: ComponentFixture<IpfmTcsformComponent>;
  let de: DebugElement;
  let el: HTMLElement;
  let service: IpfmTcsService;
  beforeEach(async(() => {
    TestBedConfigure.listConfig(
      [IpfmTcsformComponent],
      [BrowserDynamicTestingModule, HttpClientModule, HttpClientTestingModule],
      []
    );
  }));
  beforeEach(() => {
    fixture = TestBed.createComponent(IpfmTcsformComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();
    de = fixture.debugElement.query(By.css('form'));
    service = fixture.debugElement.injector.get(IpfmTcsService);
  });
