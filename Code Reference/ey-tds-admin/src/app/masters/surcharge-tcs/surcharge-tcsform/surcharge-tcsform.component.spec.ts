...
import { SurchargeTcsformComponent } from './surcharge-tcsform.component';
import { SurchargeTcsService } from '../surcharge-tcs.service';
import { By } from '@angular/platform-browser';
describe('SurchargeTcsformComponent', () => {
  let component: SurchargeTcsformComponent;

  let fixture: ComponentFixture<SurchargeTcsformComponent>;
  let de: DebugElement;
  let el: HTMLElement;
  let service: SurchargeTcsService;
  beforeEach(async(() => {
    TestBedConfigure.listConfig(
      [SurchargeTcsformComponent],
      [BrowserDynamicTestingModule, HttpClientModule, HttpClientTestingModule],
      []
    );
  }));
  beforeEach(() => {
    fixture = TestBed.createComponent(SurchargeTcsformComponent);
    component = fixture.componentInstance;
    fixture.detectChanges();
