...
import { RateMasterActformComponent } from './ratemasteractform.component';
import { RateMasterActService } from '../ratemasteract.service';
import { By } from '@angular/platform-browser';
describe('RateMasterActformComponent', () => {
  let component: RateMasterActformComponent;

  let fixture: ComponentFixture<RateMasterActformComponent>;
  let de: DebugElement;
  let el: HTMLElement;
  let service: RateMasterActService;
  beforeEach(async(() => {
    TestBedConfigure.listConfig(
      [RateMasterActformComponent],
      [BrowserDynamicTestingModule, HttpClientModule, HttpClientTestingModule],
      []
    );
  }));
  beforeEach(() => {
    fixture = TestBed.createComponent(RateMasterActformComponent);
