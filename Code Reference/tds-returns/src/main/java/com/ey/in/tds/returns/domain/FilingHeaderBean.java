...
/***
 * 
 * Bean for TDS Statement for Non Salary category (File Header Record) Same for
 * 27Q and 26Q
 */
public class FilingHeaderBean extends AbstractFilingBean {

	private static final long serialVersionUID = 8855878135072717264L;
	...
	private String tanOfDeductor;// 8
	...
	public String toString() {
		...
		if (this.fvuVersion != null && this.fvuVersion.equals("FVU 2.126")) {
			returnString = String.valueOf(this.lineNo) + "^" // 1
					+ getRecordType() + "^" // 2
					+ getFileType() + "^" // 3
					+ getUploadType() + "^" // 4
					+ getFileDate() + "^" // 5
