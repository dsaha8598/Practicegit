...
public class Form15HDTO {
    ...
    private BigDecimal numberOf15HFiled;
    private BigDecimal aggregateIncomeOf15HFiled;
    ...
    public BigDecimal getNumberOf15HFiled() {
        return numberOf15HFiled;
    }

    public void setNumberOf15HFiled(BigDecimal numberOf15HFiled) {
        this.numberOf15HFiled = numberOf15HFiled;
    }

    public BigDecimal getAggregateIncomeOf15HFiled() {
        return aggregateIncomeOf15HFiled;
    }

    public void setAggregateIncomeOf15HFiled(BigDecimal aggregateIncomeOf15HFiled) {
        this.aggregateIncomeOf15HFiled = aggregateIncomeOf15HFiled;
    }
    ...
    public String toString() {
        return new StringJoiner(", ", Form15HDTO.class.getSimpleName() + "[", "]")
                ...
                .add("numberOf15HFiled=" + numberOf15HFiled)
                .add("aggregateIncomeOf15HFiled=" + aggregateIncomeOf15HFiled)
