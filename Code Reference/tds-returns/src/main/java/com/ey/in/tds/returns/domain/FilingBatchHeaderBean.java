...
/***
 * 
 * @author Admin Bean for TDS Statement for Non Salary category (Batch Header
 *         Record) Same for 27Q and 26Q
 */
public class FilingBatchHeaderBean extends AbstractFilingBean {

	private static final long serialVersionUID = -1918887169827608353L;

	private FilingHeaderBean fileHeader;
	...
	private Map<String, Integer> lengthMap = new HashMap<String, Integer>() {
		private static final long serialVersionUID = 565827135117686547L;
		{
			...
			put("formNo", 4);// 5
			put("transactionType", 2);// 6
			put("batchUpdationIndicator", 1);// 7
			put("originalRrrNo", 15);// 8
			put("previousRrrNo", 15);// 9
			put("rrrNo", 0);// 10
			put("rrrDate", 0);// 11
			put("lastTanOfDeductor", 10);// 12
			put("tanOfDeductor", 10);// 13
			put("receiptNumber", 8);// 14
			put("panOfDeductor", 10);// 15
	...
	private String lastTanOfDeductor;// 12
	private String tanOfDeductor;// 13
	private String receiptNumber;// 14
	private String panOfDeductor;// 15
	...
	private String deductorType;// 32
	private String nameofPersonResponsilbleForSal;// 33
	private String designationofPersonResponsilbleForSal;// 34
	...
	private String approvalNo; // 52
	private String lastDeductorType;// 53
	...
	public String toString() {
		...
		if (this.fileHeader != null && this.fileHeader.getFvuVersion().equals("FVU 2.126")) {

			outString = String.valueOf(this.lineNo) + "^" // 1
					+ getRecordType() + "^" // 2
					+ getBatchNo() + "^" // 3
					+ getChallanCount() + "^" // 4
					+ getFormNo() + "^" // 5
					...
					+ getDeductorType() + "^" // 32
					+ getNameofPersonResponsilbleForSal() + "^" // 33
					+ getDesignationofPersonResponsilbleForSal() + "^" // 34
	...
	public String getLastTanOfDeductor() {
		return trim(getNullSafeValue(this.lastTanOfDeductor), lengthMap.get("lastTanOfDeductor"));
	}

	public void setLastTanOfDeductor(String lastTanOfDeductor) {
		this.lastTanOfDeductor = lastTanOfDeductor;
	}

	public String getTanOfDeductor() {
		return trim(getNullSafeValue(this.tanOfDeductor), lengthMap.get("tanOfDeductor"));
	}

	public void setTanOfDeductor(String tanOfDeductor) {
		this.tanOfDeductor = tanOfDeductor;
	}
	...
	public String getPanOfDeductor() {
		return trim(getNullSafeValue(this.panOfDeductor), lengthMap.get("panOfDeductor"));
	}

	public void setPanOfDeductor(String panOfDeductor) {
		this.panOfDeductor = panOfDeductor;
	}
	...
	public String getDeductorType() {
		return trim(getNullSafeValue(this.deductorType), lengthMap.get("deductorType"));
	}
	...
	public String getNameofPersonResponsilbleForSal() {
		return trim(getNullSafeValue(this.nameofPersonResponsilbleForSal),
				lengthMap.get("nameofPersonResponsilbleForSal"));
	}

	public void setNameofPersonResponsilbleForSal(String nameofPersonResponsilbleForSal) {
		this.nameofPersonResponsilbleForSal = nameofPersonResponsilbleForSal;
	}

	public String getDesignationofPersonResponsilbleForSal() {
		return trim(getNullSafeValue(this.designationofPersonResponsilbleForSal),
				lengthMap.get("designationofPersonResponsilbleForSal"));
	}

	public void setDesignationofPersonResponsilbleForSal(String designationofPersonResponsilbleForSal) {
		this.designationofPersonResponsilbleForSal = designationofPersonResponsilbleForSal;
	}
	...
	public String getApprovalNo() {
		return trim(getNullSafeValue(this.approvalNo), lengthMap.get("approvalNo"));
	}
	...
	public String getLastDeductorType() {
		return trim(getNullSafeValue(this.lastDeductorType), lengthMap.get("lastDeductorType"));
	}

	public void setLastDeductorType(String lastDeductorType) {
		this.lastDeductorType = lastDeductorType;
	}
	...
	public FilingHeaderBean getFileHeader() {
		return fileHeader;
	}

	public void setFileHeader(FilingHeaderBean fileHeader) {
